                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
                      ...
                      <form id="registrationForm">
                        ...
                        <!-- Password input -->
                        <div class="form-outline mb-4">
                          <input type="password" id="password-registration" class="form-control" name="password" />
                          <label class="form-label" for="password-registration">Password <small></small></label>
                        </div>

                        <!-- Repeat Password input -->
                        <div class="form-outline mb-4">
                          <input type="password" id="password-confirm-registration" class="form-control" name="passwordConfirm" />
                          <label class="form-label" for="password-confirm-registration">Repeat password <small></small></label>
                        </div>
